...
pub fn create_vertices(terrain: &market_economy_simulation_server::terrain::Terrain) -> (Vec<deferred_terrain_shader::Vertex>, Vec<u32>) {
    ...
    for y in (0..terrain.size_y-1){
        for x in (0..terrain.size_x-1){
            ...
            let height_3 = terrain.heights[y+1][x];

            let pos_0 = cgmath::Vector3::new(x as f32 * terrain.distance, y as f32 * terrain.distance, height_0);
            let pos_1 = cgmath::Vector3::new((x+1) as f32 * terrain.distance, y as f32 * terrain.distance, height_1);
            let pos_2 = cgmath::Vector3::new((x+1) as f32 * terrain.distance, (y+1) as f32 * terrain.distance, height_2);
            let pos_3 = cgmath::Vector3::new(x as f32 * terrain.distance, (y+1) as f32 * terrain.distance, height_3);
