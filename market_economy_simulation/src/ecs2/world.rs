...
use crate::{
    ...
    ground_plane::{GroundPlane, GroundResource, Location},
};

use super::{components::Agents, entity::Entity, AgentsBlue, Blues, Resources2};
...
impl World {
    pub fn new() -> Self {
        ...
        // base factory
        let base_factory = BaseFactory::new(entities.len(), Location { y: 10, x: 10 });
